...
<html lang="en">
    <head>
        ...
        <link href="../view/css/templatemo-leadership-event.css" rel="stylesheet">
...
-->
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                ...
                <a href="index.html" class="navbar-brand mx-auto mx-lg-0">
                 <span class="brand-text">Registro de <br> tareas</span>
                </a>

                <a class="nav-link custom-btn btn d-lg-none" href="#">Iniciar sesión</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="#section_2">Tareas</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="#section_3">Proyectos</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link custom-btn btn d-none d-lg-block" href="../controller/contacto.php">Iniciar sesión</a>
                        </li>
                    </ul>
                <div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-12 m-auto">
                            <div class="hero-text">
                                ...
                                <h1 class="text-white mb-4"><u class="text-info">Registro de tareas</u> DGISE </h1>

                                <div class="d-flex justify-content-center align-items-center">
                                    <span class="date-text">Junio 2023</span>

                                    <span class="location-text">Santiago del Estero</span>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 d-flex flex-column justify-content-center align-items-center">
                            <div class="speakers-text-info">
                                <h2 class="mb-4"> <u class="text-info">Integrantes</u></h2>

                                <p>Integrantes de DGISE </p>
                            </div>
                        </div>
                        5
                        <div class="col-lg-6 col-12">
                            <div class="speakers-thumb">
                                <img src="../view/images/avatar/happy-asian-man-standing-with-arms-crossed-grey-wall.jpg" class="img-fluid speakers-image" alt="">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-6 col-12">
                                    <div class="speakers-thumb speakers-thumb-small">
                                        <img src="../view/images/avatar/portrait-good-looking-brunette-young-asian-woman.jpg" class="img-fluid speakers-image" alt="">
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    <div class="speakers-thumb speakers-thumb-small">
                                        <img src="../view/images/avatar/senior-man-white-sweater-eyeglasses.jpg" class="img-fluid speakers-image" alt="">
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    <div class="speakers-thumb speakers-thumb-small">
                                        <img src="../view/images/avatar/pretty-smiling-joyfully-female-with-fair-hair-dressed-casually-looking-with-satisfaction.jpg" class="img-fluid speakers-image" alt="">
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    <div class="speakers-thumb speakers-thumb-small">
                                        <img src="../view/images/avatar/indoor-shot-beautiful-happy-african-american-woman-smiling-cheerfully-keeping-her-arms-folded-relaxing-indoors-after-morning-lectures-university.jpg" class="img-fluid speakers-image" alt="">
                        ...
                        <div class="col-lg-12 col-12">
                            ...
                            <div class="tab-content mt-5" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-DayOne" role="tabpanel" aria-labelledby="nav-DayOne-tab">
                                    <div class="row border-bottom pb-5 mb-5">
                                        <div class="col-lg-4 col-12">
                                            <img src="../view/images/schedule/fabian-friedrich-JDUVM9_VaZE-unsplash.jpg" class="schedule-image img-fluid" alt="">
                                        </div>
                                        ...
                                        <div class="col-lg-8 col-12 mt-3 mt-lg-0">
                                            ...
                                            <div class="d-flex align-items-center mt-4">
                                                <div class="avatar-group d-flex">
                                                    <img src="../view/images/avatar/happy-asian-man-standing-with-arms-crossed-grey-wall.jpg" class="img-fluid avatar-image" alt="">
                                    ...
                                    <div class="row border-bottom pb-5 mb-5">
                                        <div class="col-lg-4 col-12">
                                            <img src="../view/images/schedule/clayton-cardinalli-JMoFpdqL3XM-unsplash.jpg" class="schedule-image img-fluid" alt="">
                                        </div>
                                        ...
                                        <div class="col-lg-8 col-12 mt-3 mt-lg-0">
                                            ...
                                            <div class="d-flex align-items-center mt-4">
                                                <div class="avatar-group d-flex">
                                                    <img src="../view/images/avatar/portrait-good-looking-brunette-young-asian-woman.jpg" class="img-fluid avatar-image" alt="">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-12">
                                            <img src="../view/images/schedule/business-woman-making-presentation-office.jpg" class="schedule-image img-fluid" alt="">
                                        </div>
                                        ...
                                        <div class="col-lg-8 col-12 mt-3 mt-lg-0">
                                            ...
                                            <div class="d-flex align-items-center mt-4">
                                                <div class="avatar-group d-flex">
                                                    <img src="../view/images/avatar/senior-man-white-sweater-eyeglasses.jpg" class="img-fluid avatar-image" alt="">
                                ...
                                <div class="tab-pane fade" id="nav-DayTwo" role="tabpanel" aria-labelledby="nav-DayTwo-tab">
                                    <div class="row border-bottom pb-5 mb-5">
                                        <div class="col-lg-4 col-12">
                                            <img src="../view/images/schedule/people-smiling-while-conference-room.jpg" class="schedule-image img-fluid" alt="">
                                        </div>
                                        ...
                                        <div class="col-lg-8 col-12 mt-3 mt-lg-0">
                                            ...
                                            <div class="d-flex align-items-center mt-4">
                                                <div class="avatar-group d-flex">
                                                    <img src="../view/images/avatar/pretty-smiling-joyfully-female-with-fair-hair-dressed-casually-looking-with-satisfaction.jpg" class="img-fluid avatar-image" alt="">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-12">
                                            <img src="../view/images/schedule/jason-goodman-bzqU01v-G54-unsplash.jpg" class="schedule-image img-fluid" alt="">
                                        </div>
                                        ...
                                        <div class="col-lg-8 col-12 mt-3 mt-lg-0">
                                            ...
                                            <div class="d-flex align-items-center mt-4">
                                                <div class="avatar-group d-flex">
                                                    <img src="../view/images/avatar/indoor-shot-beautiful-happy-african-american-woman-smiling-cheerfully-keeping-her-arms-folded-relaxing-indoors-after-morning-lectures-university.jpg" class="img-fluid avatar-image" alt="">
                                ...
                                <div class="tab-pane fade" id="nav-DayFour" role="tabpanel" aria-labelledby="nav-DayFour-tab">
                                    <div class="row">
                                        <div class="col-lg-4 col-12">
                                            <img src="../view/images/schedule/jeshoots-com-TWRCH-GaKr4-unsplash.jpg" class="schedule-image img-fluid" alt="">
                                        </div>
        ...
        <script src="../view/js/click-scroll.js"></script>
